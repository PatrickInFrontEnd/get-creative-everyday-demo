...
export const boxesPL = [
    {
        header: "English",
        description:
            "Stworzony w pełni po angielsku i dedykowany  nauczycielom angielskiego",
        icon: EnglishIcon,
    },
    {
        header: "Cały rok",
        description:
            "… a nawet 13 miesięcy, kalendarz od sierpnia 2021 do sierpnia 2022",
        icon: CalendarIcon,
    },
    {
        header: "Kreatywność",
        description:
            "Pomysły na zajęcia językowe dla przedszkolaków i dzieci wczesnoszkolnych",
        icon: CreativityIcon,
    },
    {
        header: "Organizacja",
        description:
            "Wszystko w jednym miejscu – kalendarz i planner w pracy nauczyciela",
        icon: OrderIcon,
    },
];
...
export const situationsPL = [
    ...
    {
        header: "Kolejny raz poszukujesz fajnej rymowanki?",
        description: "Sprawdź w kalendarzu, na pewno ją tam znajdziesz!",
        inverted: true,
    },
    {
        header:
    ...
    {
        header: "Szukasz okazji do świętowania z uczniami?",
        description:
            "W każdym miesiącu znajdziesz listę świąt oficjalnych i nietypowych, które będą super okazją do przeprowadzenia ciekawych zajęć!",
        inverted: false,
    },
    {
        header:
...
export const detailsBoxesPL = [
    {
        header: "School Year Calendar ",
        description:
            "Kalendarz na rok szkolny zawierający zakres od sierpnia do sierpnia (kalendarz krótki i długi z miejscem na notatki)",
    },
    {
        header: "Let’s plan",
        description:
    ...
    {
        header: "Gotowy rozkład materiału",
        description:
            "Na każdy miesiąc wraz z: celami zajęć, przykładowymi piosenkami, podstawowym słownictwem i zwrotami, dodatkowym słownictwem i wyrażeniami, przykładowymi aktywnościami i zabawami (aż 60 gotowych aktywności!)",
    },
    {
        header: "Nursery rhymes",
        description:
            "20 tematycznych rymowanek, które uwielbiają młodsze dzieci",
    },
    {
        header: "Kreatywne zabawy na każdy tydzień roku ",
        description: "Aż 58 pomysłów do wykorzystania „od ręki”",
    },
    {
        header: "Let’s celebrate ",
        description: "Lista świąt oficjalnych i nietypowych na każdy miesiąc",
    },
    {
        header: "Terminarz",
        description:
            "Terminarz w układzie tygodniowym, dzięki któremu zaplanujesz pracę na każdy dzień",
    },
    {
        header: "Gotowy kalendarz",
        description:
            "Craft do wycięcia i pokolorowania z dziećmi – wspaniały pretekst do omówienia pór roku i wspólnej zabawy integrującej grupę",
    },
...
export const buyHeadersPL = [
    {
        header: "Widzisz?",
        description:
            "To nie tylko kalendarz i planner, ale po prostu niezbędnik nauczyciela angielskiego z wartościowymi materiałami, z których będziesz korzystać przez cały rok!",
    },
    {
        header: "Spiesz się! - Dlaczego warto kupić już teraz?",
        description:
